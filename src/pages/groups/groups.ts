...
export class GroupsPage {
  allmygroups;
  constructor(public app:App,public navCtrl: NavController, public navParams: NavParams, public events: Events,
  ...
  openchat(group) {
    ...
    this.app.getRootNav().push('GroupchatPage', { groupName: group.groupName });
  }
